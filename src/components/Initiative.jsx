    ...
    return (
        <div className='flex flex-col mt-40'>
            ...
            <div className='w-[98%] m-auto h-auto lg:h-[600px] flex flex-col bg-[#1f2B22] rounded-3xl justify-center mt-[40px] lg:mt-[60px] mb-5 relative py-4'>
                ...
                <img src={icon} alt='initiative-icon' className='hidden xl:block absolute w-[200px] lg:w-[250px] bottom-0 lg:-bottom-28 right-4 lg:-right-20 h-[200px] lg:h-[250px] -z-1 ' />
