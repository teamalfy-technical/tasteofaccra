...
const Newsletter = () => {
    ...
    return (
        <div  id='newsletter' className='flex flex-col w-[90%] m-auto justify-center items-center text-center mt-28 relative'>
            <div className='absolute md:left-[6%] xl:left-[20%] 2xl:left-[26%] -top-[44%] -z-20 opacity-15'>
                <Lottie
