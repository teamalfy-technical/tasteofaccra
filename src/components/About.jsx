...
const About = () => {
    ...
    return (
        <div id='about' className='relative flex flex-col justify-center bg-white'>
            ...
            <div className='flex flex-col justify-center w-full text-center  lg:-mt-[10%] xl:-mt-[6%] pb-[80px]'>
                <h1 className='font-bold text-[32px] sm:text-[48px] md:text-[64px] lg:text-[78px] pb-[20px]'>About The Event</h1>
